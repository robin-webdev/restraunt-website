...
const Gallary = () => {
  return (
    <section className="flex flex-col gap-10 font-poppins">
      <h1 className="  stroke-[#d2e40f] flex flex-col items-center text-white text-poppins gap-1 text-3xl font-bold text-center">
        Our Gallary
      ...
      <div className="flex gap-10 p-4 overflow-auto w-screen">
        <img
          ...
          className="rounded-3xl object-cover shadow-lg/30 shadow-[#c6c6c6]"
          alt=""
        />  
        <img
          className="rounded-3xl object-cover shadow-lg/30 shadow-[#c6c6c6]"
