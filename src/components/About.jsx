...
const About = () => {
  return (
    <section className="text-white flex-col-reverse lg:flex-row gap-20 lg:gap-10  px-7 md:px-12 lg:px-7 xl:px-12 flex items-center justify-center xl:items-start">
